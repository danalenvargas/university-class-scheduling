...
<html>
    <head>
        ...
        <script src="script/validateSchedule.js" type="text/javascript"></script>
    ...
    <body ng-app="main" ng-controller="SchedCtrl">
        ...
        <div class="heading" style="background-color:transparent; height:50px; left:8px; top:95px; padding:0px;">
            <ul>
                <li><a href="colreg_account_mngt.jsp">Account Management <br>(create and edit scheduler accounts)</a></li>
                <li><a href="colreg_collab.jsp">Chat & Notifications & Schedule Sharing</a></li>
                <li><a href="colreg_sched.jsp">Scheduling (plot schedules)</a></li>
                <li><a href="colreg_validate.jsp">Validate schedules</a></li>
                <li><a href="colreg_setup.jsp">Setup (create edit delete info)</a></li>
        ...
        <br />
        <label>Selection:</label> <select name="ddlSelect" ng-model="selectedItem" ng-options="item as item.name group by item.groupName for item in selectionList" ng-change="getSchedTable()">
        </select>
        <br /><br />
        <button id="btnReturnAll" ng-click="returnAll()">Return All</button>
        <button id="btnLockAll" ng-click="lockAll()">Lock All</button>
        <button id="btnApproveAll" ng-click="approveAll()">Approve All</button>
        ...
        <script type="text/ng-template" id="sectionsTable.html">
            ...
            ng-click="openColregValidationModal(row)" ng-class="{'lastCell':rowIndx === column.length - 1}">
        ...
        <script type="text/ng-template" id="instructorsTable.html">
            ...
            <div ng-repeat="(colIndx,column) in schedule.contents" style="box-sizing: border-box; display: inline-block; position: relative; height:{{schedule.height + 'px'}};width:{{schedule.width + 'px'}}">
            <div ng-repeat="(rowIndx,row) in column" style="box-sizing: border-box;border:1px solid black;height:{{row.height + 'px'}}" 
            ng-click="adjust(rowIndx, colIndx)" ng-class="{'lastCell':rowIndx === column.length - 1}">
